    ...
    <>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          {/* Mobile menu */}
          <div className="fixed top-16 md:top-20 left-1/2 transform -translate-x-1/2 w-[90%] max-w-sm bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl p-4">
            {session ? (
              <>
              ...
              <>
                ...
                <div className="space-y-2">
                  ...
                  <Link 
                    href={`/${lang}/auth/login`}
                    className="flex items-center gap-3 w-full p-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition-colors"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
